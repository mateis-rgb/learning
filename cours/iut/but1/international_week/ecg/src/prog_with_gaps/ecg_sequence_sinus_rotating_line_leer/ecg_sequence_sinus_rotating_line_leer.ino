...
void loop(void)
{
  ...
  DrawLine(160, 120, 160+100*cos(val_rad), 120+100*sin(val_rad), ???);  //draw new line
  DrawLine(160, 120, 160+100*cos(val_rad_alt), 120+100*sin(val_rad_alt), ???);  // erase old line
  DrawLine(160, 120, 160+100*cos(val_rad), 120+100*sin(val_rad), ???);  // draw new line again
  val_rad_alt=val_rad;
  val_alt=val;
  }
  delay(50);
